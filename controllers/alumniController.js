...
exports.getAllAlumni = async (req, res) => {
  try {
    ...
    const alumni = await Alumni.find(filter).select("firstName lastName department batchYear degree programmeType currentCompany jobTitle occupation profileImage social membershipStatus");
...
exports.getAlumniById = async (req, res) => {
  try {
    const alumni = await Alumni.findOne({ _id: req.params.id, role: "Alumni", isApproved: true })
      .select("firstName lastName department batchYear degree programmeType currentCompany jobTitle occupation profileImage social membershipStatus");
