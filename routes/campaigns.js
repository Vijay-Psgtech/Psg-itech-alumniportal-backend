...
// GET SINGLE RESPONSE
// ==============================
router.get("/response/:responseId", adminAuth, async (req, res) => {
  try {
...
// ==============================
router.put("/response/:responseId/status", adminAuth, async (req, res) => {
  try {
    const { responseId } = req.params;
...
// ==============================
router.post("/response/:responseId/publish", adminAuth, async (req, res) => {
  try {
    const { responseId } = req.params;
...
// DELETE RESPONSE
// ==============================
router.delete("/response/:responseId", adminAuth, async (req, res) => {
  try {
    const { responseId } = req.params;
...
// ==============================
router.get("/:id/responses/export", adminAuth, async (req, res) => {
  try {
    const { id } = req.params;
...
// ==============================
router.get("/:id/responses", adminAuth, async (req, res) => {
  try {
    const { id } = req.params;
    const { status: statusFilter } = req.query;
