...
const mentorshipSessionSchema = new mongoose.Schema(
  {
    ...
    mentee: { type: mongoose.Schema.Types.ObjectId, ref: "Alumni", required: true },
    topics: [{ type: String, trim: true }],
    requestedAt: { type: Date, default: Date.now },
    sessionDate: Date,
    status: { type: String, enum: ["awaiting_response", "awaiting_feedback", "upcoming", "completed", "cancelled"], default: "awaiting_response" },
